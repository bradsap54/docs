...
|                                                                                         | **CPU** | **RAM** | **Storage** | **Remarks**                                            |
| --------------------------------------------------------------------------------------- | :-----: | :-----: | :---------: | :----------------------------------------------------: |
| **Minimum Requirements**<br />_For trial deployments_                                   | 4       | 8 GB    | 50 GB       | Swap memory activation required—see Installation Steps |
| **Standard Requirements**<br />_For production environments and continuous development_ | 8       | 12 GB   | 100 GB      | No need swap memory                                    |
